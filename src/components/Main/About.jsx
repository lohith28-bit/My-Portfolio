    ...
    <section className="sobre-mi" id="sobre-mi">
        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>My name is Lohith V P and I am a MERN stack developer.
                </h4>
                <p>I have been working on web designing and web development for 4 months. I have always been passionate about learning new skills and trying to improve myself every day as a developer.
                </p>
                <ul>
                    <li>
                        <p>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="java" className="icons-skils" src="https://www.vectorlogo.zone/logos/java/java-icon.svg" title="java" />
                        <h5>Java</h5>
                    </div>
                    <div>
                        <img alt="python" className="icons-skils" src="https://www.vectorlogo.zone/logos/python/python-icon.svg" title="python" />
                        <h5>Python</h5>
                    </div>
                    <div>
                        <img alt="c++" className="icons-skils" src="https://upload.wikimedia.org/wikipedia/commons/1/18/ISO_C%2B%2B_Logo.svg" title="python" />
                        <h5>C++</h5>
                    </div>
                </div>
            </div>
